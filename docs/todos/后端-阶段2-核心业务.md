...
- [ ] FieldEnhancement Repository（CRUD）
...
- [ ] POST /api/data/{model}/query（通用查询）
- [ ] GET /api/data/{model}（列表+模板）
- [ ] GET /api/data/{model}/{id}（详情）
- [ ] POST /api/data/{model}（创建）
- [ ] PUT /api/data/{model}/{id}（更新）
- [ ] DELETE /api/data/{model}/{id}（删除）

### 6.2 批量操作接口

- [ ] POST /api/data/{model}/batch-create
- [ ] PUT /api/data/{model}/batch-update
- [ ] DELETE /api/data/{model}/batch-delete

### 6.3 统计查询接口

- [ ] GET /api/data/{model}/statistics（统计）
- [ ] POST /api/data/{model}/aggregate（聚合）
