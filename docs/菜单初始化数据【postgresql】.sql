...
INSERT INTO "sso_menu" (
    ...
    1, '1', true, 'C', 'fa-gauge-high',
    '/home/dashboard', 'GET', '', '首页仪表盘', 1, 1,
    false, true, '1', '0', 'system'
);
