...
type SsoUserGroupRole struct {
	...
	GroupID   string    `json:"group_id" form:"group_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_user_group_role;column:group_id"`
	RoleID    string    `json:"role_id" form:"role_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_user_group_role;column:role_id"`
