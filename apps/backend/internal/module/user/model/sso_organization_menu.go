...
type SsoOrganizationMenu struct {
	...
	OrganizationID string    `json:"organization_id" form:"organization_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_org_menu;column:organization_id;comment:组织ID"`
