...
// SsoOrganizationMenu 菜单和部门关联表模型
type SsoOrganizationMenu struct {
	ID             string    `json:"id" form:"id" gorm:"primary_key;type:varchar(64);column:id"`
	MenuID         string    `json:"menu_id" form:"menu_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_org_menu;column:menu_id"`
	OrganizationID string    `json:"organization_id" form:"organization_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_org_menu;column:organization_id"`
...
// TableName 指定表名
func (SsoOrganizationMenu) TableName() string {
	return "sso_organization_menu"
}
