...
// SsoOrganizationKindRole 组织类型角色表模型
type SsoOrganizationKindRole struct {
	ID        string    `json:"id" form:"id" gorm:"primary_key;type:varchar(64);column:id"`
	KindCode  string    `json:"kind_code" form:"kind_code" gorm:"size:64;default:'';uniqueIndex:idx_kind_role;column:kind_code"`
	RoleID    string    `json:"role_id" form:"role_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_kind_role;column:role_id"`
...
// TableName 指定表名
func (SsoOrganizationKindRole) TableName() string {
	return "sso_organization_kind_role"
}
