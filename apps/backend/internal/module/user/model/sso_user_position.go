...
type SsoUserPosition struct {
	...
	UserID     string    `json:"user_id" form:"user_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_user_position;column:user_id;comment:用户ID"`
	PositionID string    `json:"position_id" form:"position_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_user_position;column:position_id;comment:职位ID"`
