...
type SsoOrgRole struct {
	...
	OrgID     string    `json:"org_id" form:"org_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_org_role;column:org_id;comment:组织ID"`
	RoleID    string    `json:"role_id" form:"role_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_org_role;column:role_id;comment:角色ID"`
