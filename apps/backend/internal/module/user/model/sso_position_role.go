...
type SsoPositionRole struct {
	...
	PosID     string    `json:"pos_id" form:"pos_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_pos_role;column:pos_id"`
	RoleID    string    `json:"role_id" form:"role_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_pos_role;column:role_id"`
