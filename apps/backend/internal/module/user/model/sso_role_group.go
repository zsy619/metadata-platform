...
type SsoRoleGroup struct {
	...
	GroupName       string    `json:"group_name" form:"group_name" gorm:"size:128;default:'';column:group_name"`
	GroupCode       string    `json:"group_code" form:"group_code" gorm:"size:128;uniqueIndex;default:'';column:group_code"`
...
// TableName 指定表名
func (SsoRoleGroup) TableName() string {
	return "sso_role_group"
}
