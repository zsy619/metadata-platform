...
type SsoOrganizationUser struct {
	...
	OrganizationID string    `json:"organization_id" form:"organization_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_org_user;column:organization_id;comment:组织ID"`
