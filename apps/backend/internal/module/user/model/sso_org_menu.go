...
type SsoOrgMenu struct {
	...
	MenuID    string    `json:"menu_id" form:"menu_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_org_menu;column:menu_id;comment:菜单ID"`
	OrgID     string    `json:"org_id" form:"org_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_org_menu;column:org_id;comment:组织ID"`
