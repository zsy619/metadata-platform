...
type SsoApplication struct {
	...
	ApplicationName string    `json:"application_name" form:"application_name" gorm:"size:32;default:'';column:application_name;comment:应用名称"`
	ApplicationCode string    `json:"application_code" form:"application_code" gorm:"size:64;uniqueIndex;default:'';column:application_code;comment:应用编码"`
