...
type SsoUserGroupUser struct {
	...
	GroupID   string    `json:"group_id" form:"group_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_group_user;column:group_id"`
	UserID    string    `json:"user_id" form:"user_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_group_user;column:user_id"`
