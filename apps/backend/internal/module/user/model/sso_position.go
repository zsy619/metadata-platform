...
type SsoPosition struct {
	...
	PosName         string    `json:"pos_name" form:"pos_name" gorm:"size:128;default:'';column:pos_name"`
	PosCode         string    `json:"pos_code" form:"pos_code" gorm:"size:64;uniqueIndex;default:'';column:pos_code"`
