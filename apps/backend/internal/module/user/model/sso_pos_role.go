...
type SsoPosRole struct {
	...
	PosID     string    `json:"pos_id" form:"pos_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_pos_role;column:pos_id;comment:职位ID"`
	RoleID    string    `json:"role_id" form:"role_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_pos_role;column:role_id;comment:角色ID"`
