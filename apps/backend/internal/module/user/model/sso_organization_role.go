...
// SsoOrganizationRole 角色和部门关联表模型
type SsoOrganizationRole struct {
	ID             string    `json:"id" form:"id" gorm:"primary_key;type:varchar(64);column:id"`
	OrganizationID string    `json:"organization_id" form:"organization_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_org_role;column:organization_id;comment:组织ID"`
	RoleID         string    `json:"role_id" form:"role_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_org_role;column:role_id;comment:角色ID"`
...
// TableName 指定表名
func (SsoOrganizationRole) TableName() string {
	return "sso_organization_role"
}
