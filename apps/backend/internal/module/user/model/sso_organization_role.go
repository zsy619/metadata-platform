...
type SsoOrganizationRole struct {
	...
	OrganizationID string    `json:"organization_id" form:"organization_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_org_role;column:organization_id"`
	RoleID         string    `json:"role_id" form:"role_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_org_role;column:role_id"`
