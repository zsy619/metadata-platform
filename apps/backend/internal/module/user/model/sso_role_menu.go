...
type SsoRoleMenu struct {
	...
	RoleID    string    `json:"role_id" form:"role_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_role_menu;column:role_id;comment:角色ID"`
	MenuID    string    `json:"menu_id" form:"menu_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_role_menu;column:menu_id;comment:菜单ID"`
