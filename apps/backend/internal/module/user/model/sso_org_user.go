...
// SsoOrgUser 组织和用户关联表模型
type SsoOrgUser struct {
	ID        string    `json:"id" form:"id" gorm:"primary_key;type:varchar(64);column:id;comment:主键ID"`
	OrgID     string    `json:"org_id" form:"org_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_org_user;column:org_id;comment:组织ID"`
	UserID    string    `json:"user_id" form:"user_id" gorm:"type:varchar(64);default:'0';uniqueIndex:idx_org_user;column:user_id;comment:用户ID"`
...
// TableName 指定表名
func (SsoOrgUser) TableName() string {
	return "sso_org_user"
}
