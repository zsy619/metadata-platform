...
type SsoOrgUser struct {
	...
	OrgID     string    `json:"org_id" form:"org_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_org_user;column:org_id;comment:组织ID"`
	UserID    string    `json:"user_id" form:"user_id" gorm:"type:varchar(64);default:'';uniqueIndex:idx_org_user;column:user_id;comment:用户ID"`
