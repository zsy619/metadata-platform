...
type API struct {
	...
	Name      string     `json:"name" form:"name" gorm:"size:128;not null;comment:API名称"`
	Code      string     `json:"code" form:"code" gorm:"size:128;not null;uniqueIndex;comment:API编码"`
	Path      string     `json:"path" form:"path" gorm:"size:512;not null;comment:API路径"`
	...
	UpdatedAt time.Time  `json:"updated_at" form:"updated_at" gorm:"autoUpdateTime;comment:更新时间"`
	DeletedAt *time.Time `json:"deleted_at,omitempty" form:"deleted_at" gorm:"index;comment:删除时间"`
}