...
type MdModelWhere struct {
	...
	WhereTableID      string    `json:"where_table_id" form:"where_table_id" gorm:"type:varchar(64);not null;default:'';comment:比较表ID"`
	...
	WhereColumnID     string    `json:"where_column_id" form:"where_column_id" gorm:"type:varchar(64);not null;default:'';comment:比较字段ID"`
