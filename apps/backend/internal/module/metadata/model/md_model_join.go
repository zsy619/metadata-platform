...
type MdModelJoin struct {
	...
	ParentID         string    `json:"parent_id" form:"parent_id" gorm:"type:varchar(64);not null;default:'';comment:父ID"`
	...
	JoinTableID      string    `json:"join_table_id" form:"join_table_id" gorm:"type:varchar(64);not null;default:'';comment:关联表ID"`
...
type MdModelJoinField struct {
	...
	JoinColumnID    string    `json:"join_column_id" form:"join_column_id" gorm:"type:varchar(64);not null;default:'';comment:关联字段ID"`
