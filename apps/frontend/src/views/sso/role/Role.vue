    ...
    <el-card class="main-card">
      ...
      <div class="table-area">
        ...
        >
          ...
          <el-table-column prop="role_name" label="角色名称" min-width="260">
...
const tableData = computed(() => {
  ...
  if (!searchQuery.value && (filterStatus.value === '' || filterStatus.value === undefined)) {
...
.search-area { display: flex; align-items: center; margin-bottom: 20px; flex-shrink: 0; }
