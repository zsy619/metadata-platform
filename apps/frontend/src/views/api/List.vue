    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="apiType" label="接口类型" width="120">
          <template #default="scope">
            <el-tag
              :type="getAPITypeTagType(scope.row.apiType)"
            >
        ...
        <el-table-column prop="needAuth" label="需要鉴权" width="120">
          <template #default="scope">
            <el-tag
              :type="scope.row.needAuth ? 'success' : 'info'"
            >
...
import { getAPIs, enableAPI, disableAPI, deleteAPI } from '@/api/api'
