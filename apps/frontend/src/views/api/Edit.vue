            ...
            >
              ...
              <el-table-column prop="paramType" label="参数类型" width="120">
                <template #default="scope">
                  <el-tag
                    :type="getParamTypeTagType(scope.row.paramType)"
                  >
          ...
          <div class="response-config">
            ...
            >
              ...
              <el-table-column prop="exampleValue" label="示例值" width="150">
                <template #default="scope">
                  <el-input
                    v-model="scope.row.exampleValue"
                    size="small"
                    placeholder="请输入示例值"
                  />
                </template>
              ...
              <el-table-column label="操作" width="120" fixed="right">
                <template #default="scope">
                  <el-button
                    ...
                    size="small"
                    :icon="Delete"
                    @click="handleDeleteResponseField(scope.row)"
                  >
                    删除
                  </el-button>
                </template>
...
import { getAPIById, updateAPI } from '@/api/api'
